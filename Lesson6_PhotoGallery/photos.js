...
function previewFive() {
   ...
   var lastFigure = document.createElement("figure");
    ...
    //add or attach the iffth image to preview
    lastFigure.appendChild(lastImage);
    
    articleEl.appendChild(lastFigure);
    
    //clone figure element ofr fifth image and edit to be first image
...
function createEventListeners() {
    ...
    //when the user clicks the Show Mre button the previewFive() function is executed
